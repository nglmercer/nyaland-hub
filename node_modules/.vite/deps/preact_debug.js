...
function a(e) {
  return e.type === S ? "Fragment" : "function" == typeof e.type ? e.type.displayName || e.type.name : "string" == typeof e.type ? e.type : "#text";
}
var i = [];
var s = [];
function c() {
...
var l2 = true;
function u(e) {
  return "function" == typeof e.type && e.type != S;
}
function f(n) {
...
` + f(n));
  ...
  var n = false, o = l.__b, r2 = l.diffed, c2 = l.vnode, l3 = l.__r, v2 = l.__e, b2 = l.__, g = l.__h, E = d ? { useEffect: /* @__PURE__ */ new WeakMap(), useLayoutEffect: /* @__PURE__ */ new WeakMap(), lazyPropTypes: /* @__PURE__ */ new WeakMap() } : null, k = [];
  ...
  var O = function(n2, e) {
    return { get: function() {
      var o2 = "get" + n2 + e;
      k && k.indexOf(o2) < 0 && (k.push(o2), console.warn("getting vnode." + n2 + " is deprecated, " + e));
    }, set: function() {
      var o2 = "set" + n2 + e;
      k && k.indexOf(o2) < 0 && (k.push(o2), console.warn("setting vnode." + n2 + " is not allowed, " + e));
    } };
  ...
  l.vnode = function(n2) {
    ...
    if (null != e.__c && null != e.__c.__H) {
      ...
      if (b3) for (var g2 = 0; g2 < b3.length; g2 += 1) {
        var E2 = b3[g2];
        if (E2.__H) {
          for (var k2 = 0; k2 < E2.__H.length; k2++) if ((o2 = E2.__H[k2]) != o2) {
            var O2 = a(e);
